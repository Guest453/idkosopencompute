return {
  ...
  notes = {
    ...
    "one-shot ram-resident .os update environment",
    "white background and black diagnostic text",
    "rollback if a file cannot be applied",
    "kernel panic screen for fatal shell crashes"
  },
  files = {
